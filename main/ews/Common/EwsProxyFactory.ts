...
import { RequestedAuthType, EwsEditorAppSettings } from "./EwsEditorServiceInstanceSettings"
...
export class EwsProxyFactory {
  ...
  public static SetAppSettingsFromProxyFactory(/* ref */oSettings: EwsEditorAppSettings) {
    oSettings.MailboxBeingAccessed = EwsProxyFactory.MailboxBeingAccessed
    oSettings.AccountAccessingMailbox = EwsProxyFactory.AccountAccessingMailbox
    if ((EwsProxyFactory.EwsUrl != null)) {
      oSettings.UrlHost = EwsProxyFactory.EwsUrl.Host
    } else {
      oSettings.UrlHost = ""
    }

    oSettings.AuthenticationMethod = EwsProxyFactory.AuthenticationMethod
    //  Default, UserSpecified, oAuth
    oSettings.UseAutoDiscover = EwsProxyFactory.UseAutoDiscover
    oSettings.RequestedAutodiscoverEmail = EwsProxyFactory.RequestedAutodiscoverEmail
    oSettings.RequestedExchangeServiceURL = EwsProxyFactory.RequestedExchangeServiceURL
    oSettings.RequestedExchangeVersion = EwsProxyFactory.RequestedExchangeVersion
    oSettings.UserName = EwsProxyFactory.UserName
    oSettings.Password = EwsProxyFactory.Password
    oSettings.Domain = EwsProxyFactory.Domain
    oSettings.UserImpersonationSelected = EwsProxyFactory.UserImpersonationSelected
    oSettings.UserToImpersonate = EwsProxyFactory.UserToImpersonate
    oSettings.ImpersonationType = EwsProxyFactory.ImpersonationType
    oSettings.ImpersonatedId = EwsProxyFactory.ImpersonatedId
    oSettings.UseoAuth = EwsProxyFactory.UseoAuth
    oSettings.oAuthRedirectUrl = EwsProxyFactory.oAuthRedirectUrl
    oSettings.oAuthClientId = EwsProxyFactory.oAuthClientId
    oSettings.oAuthServerName = EwsProxyFactory.oAuthServerName
    oSettings.oAuthAuthority = EwsProxyFactory.oAuthAuthority
    oSettings.EnableAdditionalHeader1 = EwsProxyFactory.EnableAdditionalHeader1
    oSettings.AdditionalHeader1 = EwsProxyFactory.AdditionalHeader1
    oSettings.AdditionalHeaderValue1 = EwsProxyFactory.AdditionalHeaderValue1
    oSettings.EnableAdditionalHeader2 = EwsProxyFactory.EnableAdditionalHeader2
    oSettings.AdditionalHeader2 = EwsProxyFactory.AdditionalHeader2
    oSettings.AdditionalHeaderValue2 = EwsProxyFactory.AdditionalHeaderValue2
    oSettings.EnableAdditionalHeader3 = EwsProxyFactory.EnableAdditionalHeader3
    oSettings.AdditionalHeader3 = EwsProxyFactory.AdditionalHeader3
    oSettings.AdditionalHeaderValue3 = EwsProxyFactory.AdditionalHeaderValue3
  }
}
