...
//   public static IsEqual(perm1: FolderPermission, perm2: FolderPermission): boolean {
...
//   public static IsEqual(oof1: OofSettings, oof2: OofSettings): boolean {
...
//       if (((oof1.ExternalReply == null) 
//                   | (oof2.ExternalReply == null))) {
//           return false;
//           // The operator should be an XOR ^ instead of an OR, but not available in CodeDOM
//       }
...
//       if (((oof1.InternalReply == null) 
//                   | (oof2.InternalReply == null))) {
//           return false;
//           // The operator should be an XOR ^ instead of an OR, but not available in CodeDOM
//       }
